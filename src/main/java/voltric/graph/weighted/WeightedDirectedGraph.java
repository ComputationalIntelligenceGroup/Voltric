...
import voltric.graph.DirectedGraph;
...
/**
 * This class provides an implementation of a directed graph where its edges have an associated weight. It inherits
 * {@link DirectedGraph}. It provides a specific set of methods and overrides some of the parent, to provide an
...
public class WeightedDirectedGraph<T> extends DirectedGraph<T> implements WeightedGraph<T>{
     ...
     */
    public WeightedDirectedGraph(WeightedDirectedGraph<T> graph){
     ...
     *
     * @param graph the directed graph being used as base (that will be copied).
     */
    ...
    /**
     * Returns {@code true} if the object is a {@code WeightedDirectedGraph} with equal fields (inherited ones included).
     *
    ...
    public boolean equals(Object object){
        ...
        WeightedDirectedGraph graph = (WeightedDirectedGraph) object;
     ...
     */
    @Override
    public WeightedDirectedGraph<T> clone(){
    ...
    public String toString(int amount){
        ...
        stringBuffer.append("weighted directed graph {\n");
